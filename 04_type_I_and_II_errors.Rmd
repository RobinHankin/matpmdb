...
In the figure above, the critical region is indicated in grey.  We
reject the null if our test statistic (the sample mean) falls in the
grey region.  If the null is true, the probability of rejecting it is
0.05: in other words, the size of the test is 5\%
