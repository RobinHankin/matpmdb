...
$4$.  See how the variance rapidly approaches 4 as $n$ approaches
infinity.  We can get a visual impression of the limiting process by
examining the following diagram which shows a range of $n$:
