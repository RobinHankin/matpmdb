...
hold the product $np$ constant.  Consider the following table, showing
values of $n$ becoming larger and larger, and $p$ adjusted so that the
product $np$ is always equal to $4$:
