...
A person takes one of these dice and throws it, obtaining a 5.
Suppose our priors are $p(H_4)=0.1, p(H_6)=0.8, p(H_8)=0.1$.  Then the
likelihoods are $p(D|H_4)=0$ (think about it), $p(D|H_6)=\frac{1}{6}$
and $p(D|H_8)=\frac{1}{8}$.  Bayes gives us
