...
We can observe straightaway that $1\leq r\leq n$ as it is impossible
to have more than $n$ successes, or less than zero.

If the random variable $X$ denotes the number of successes out of $n$
trials each of probability $p$, it is straightforward to show that
...
In the plot above, exact agreement would mean the points are exactly
on the diagonal line; see how close the agreement is.
