---
title: "stat601 lab, week 1, binomial distribution"
output: pdf_document
---
...
builds on chapter 1 of the course manual for stat601.  You will need
...
$X\sim\operatorname{bin}\left(n,\frac{1}{2}\right)$, we are interested
