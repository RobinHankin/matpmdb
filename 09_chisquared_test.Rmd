...
n <- 1e5
hist(replicate(n,f()),col='red',nclass=30)
x <- seq(from=0,to=10,len=100)
points(x,n*dchisq(x,df=3),type='l',lwd=6)
```
...
We need to calculate an expectation to compare this observation against.  The mean number of goals is:
